...
{
    public class Initializer2 : IGomoriInitializer
    {
        ...
        private Vector<double> _b = new DenseVector(new double[] { 15, 6, 0 });
        ...
        private Vector<double> _c = new DenseVector(new double[] { -3.5, 1, 0, 0, 0 });
