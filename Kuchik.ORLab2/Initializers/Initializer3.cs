...
{
    public class Initializer3 : IGomoriInitializer
    {
        ...
        private Vector<double> _b = new DenseVector(new double[] { -1, 10, 3 });
        ...
        private Vector<double> _c = new DenseVector(new double[] { 2, -5, 0, 0, 0 });
