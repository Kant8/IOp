...
{
    public class SimplexInit1 : IGomoriInitializer
    {
        ...
        private Vector<double> _b = new DenseVector(new double[] { 1, 2, 3 });
        ...
        private Vector<double> _c = new DenseVector(new double[] { -3, 1, 4, 0, 0 });
