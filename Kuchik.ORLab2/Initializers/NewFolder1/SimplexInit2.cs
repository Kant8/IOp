...
{
    public class SimplexInit2 : IGomoriInitializer
    {
        ...
        private Vector<double> _b = new DenseVector(new double[] { 16, 18, 24 });
        ...
        private Vector<double> _c = new DenseVector(new double[] { 2, 3, 0, -1, 0, 0 });
